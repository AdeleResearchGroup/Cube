 ...
 *
 */
public class ScopeLeaderID extends CubeAgentID {
	...
	public ScopeLeaderID(CubeID ciid) throws InvalidIDException {
		super(ciid);		
		if (ciid.getHierarchicalPart().contains("/scopeleader")) {
			...
			throw new InvalidIDException("Invalid ScopeLeader ID! " + ciid);
		}
	}
		
	public ScopeLeaderID(CoreExtension ex) throws InvalidIDException  {
	...
	public static boolean check(CubeID id) {	
		if (id != null) {
			if (id.getHierarchicalPart().contains("/scopeleader")) {
				return true;
			}
		}
		return false;
	...
	public String getURI() {
		...
		return "cube://"+this.getHost()+":"+this.getPort() +"/"+this.extensionID +"/scopeleader";
	}
}
