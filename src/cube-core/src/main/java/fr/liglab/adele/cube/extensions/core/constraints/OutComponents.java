...
public class OutComponents extends Constraint {

	String max;
	
	public OutComponents(String v, String max, String id, String description, int priority,
			Archetype archtype) {
	...
	public static final String NAME = "out-components";
