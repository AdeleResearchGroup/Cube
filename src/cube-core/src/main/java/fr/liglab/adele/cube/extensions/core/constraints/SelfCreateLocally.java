...
public class SelfCreateLocally extends Constraint {

	public static final String NAME = "self-create-locally";
		
	public SelfCreateLocally(String v, String id, String description,
