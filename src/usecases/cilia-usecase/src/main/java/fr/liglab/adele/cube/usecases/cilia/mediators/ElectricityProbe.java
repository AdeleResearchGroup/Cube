...
public class ElectricityProbe extends AbstractPullCollector {
	...
	protected List pullData() throws IOException {
		System.out.println("ElectricityProbe is called");
		Random rn = new Random();
        long number = rn.nextInt() % 100;
        return Collections.singletonList(new Data(number, "electricity-probe"));
	}
