...
import fr.liglab.adele.cube.extensions.script.ScriptExtensionFactory;
...
@Provides
@Instantiate
public class ScriptExtensionFactoryImpl implements ScriptExtensionFactory {
    ...
    public Extension newExtensionInstance(AutonomicManager am, Properties properties) {
        return new ScriptExtension(am, this, properties);
    }
}
