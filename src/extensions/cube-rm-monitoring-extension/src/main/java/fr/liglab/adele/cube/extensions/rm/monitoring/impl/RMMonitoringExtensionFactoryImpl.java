...
import fr.liglab.adele.cube.extensions.rm.monitoring.RMMonitoringExtensionFactory;
...
@Provides
@Instantiate
public class RMMonitoringExtensionFactoryImpl implements RMMonitoringExtensionFactory {
    ...
    public Extension newExtensionInstance(AutonomicManager am, Properties properties) {
        return new RMMonitoringExtension(am, this, properties);
    }
}
