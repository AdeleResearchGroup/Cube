...
@Provides
@Instantiate
public class OSGiExtensionFactory implements IExtensionFactory {

	public static final String ID = "fr.liglab.adele.cube.osgi";
	 ...
	 * {@inheritDoc}
	 */
	public IExtension newExtension(CubeAgent agent, AgentExtensionConfig config) throws Exception{
		return new OSGiExtension(agent, this, config);
	}
